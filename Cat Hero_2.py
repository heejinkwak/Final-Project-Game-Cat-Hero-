...
class Player(pygame.sprite.Sprite):
    def __init__(self):
        ...
        self.image = pygame.transform.scale(player_img, (120, 130))
...
background = pygame.image.load(path.join(img_dir, "background.svg")).convert()
background_rect = background.get_rect()
player_img = pygame.image.load(path.join(img_dir, "character_stage2.png")).convert()
bullet_img = pygame.image.load(path.join(img_dir, "rock.png")).convert()
bullet_img = pygame.transform.scale(bullet_img, (90,90))
meteor_images = []
meteor_list = ['Grape_nnew.png','salmon.png','choco copy.png','chicken.png']
...
explosion_anim['sm'] = []
for i in range(9):
    filename = 'collide copy.png'.format(i)
